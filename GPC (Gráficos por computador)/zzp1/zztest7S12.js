...
// varying, común a vertex y fragments
  'attribute vec4 posicion;                 \n' +
  'varying float luminosidad;               \n' +
  'void main(){                             \n' +
    'float distancia = sqrt(posicion[0] * posicion[0] + posicion[1] * posicion[1]);                \n' +
    'luminosidad = sqrt(2.0) - distancia;   \n' +
    'gl_Position = posicion;                \n' +
  // Tamaño depende de la posición, de la distancia euclídea
    'gl_PointSize = 20.0 - distancia * 15.0;\n' +
  '}                                        \n' ;

// Shader de fragmentos
var FSHADER_SOURCE =
// Definir precisión de float en fragments
  'precision mediump float;                          \n' +
  'varying float luminosidad;                        \n' +
  'void main(){                                      \n' +
    'gl_FragColor = vec4(1.0, 0.0, 0.0, luminosidad);\n' +
  '}                                                 \n';
